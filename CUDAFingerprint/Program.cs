...
namespace CUDAFingerprint
{
    internal class Program
    {
        ...
        private static extern void Comparing(int[] data, int dataCount, int[] sample, int sampleCount, int[] maskData, int[] maskSample, int[] offset, int offsetCount, float[] result, int numberOfBlocks);
